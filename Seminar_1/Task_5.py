...
i = int(input("Введите вогон в который педпологал сесть Витя: ")) # вогон в который педпологал сесть Витя
j = int(input("Введите вагон в который Витя сел фактически: ")) # вагон в который Витя сел фактически
if(i == j):
    print("Витя, пройдись и посчитай количество вагонов до головы поезда")
else:
